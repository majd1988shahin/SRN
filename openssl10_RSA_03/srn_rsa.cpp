...
public:
    ...
    void op()
    {
        ...
        char plainText[2048/8] = "Hello worldkhgfdsfghjkl,mnbgfvdrtyuiolkjhgfdrftyuio"; //key length : 2048

        string user="majd";
        string user2="janik";


        string pass ="akdfvmdslvnjskjfdfghjkl;'lkjlhkjdxioio;lnkjd";
        generate_key(user,pass);


        //generate_key(user2,pass);
        public_encrypt_user((unsigned char*)plainText,strlen(plainText),(unsigned char*)encrypted,user);

        int decrypted_length = private_decrypt_user((unsigned char*)encrypted,256, (unsigned char*)decrypted,user,pass);
                cout<<plainText<<endl;
